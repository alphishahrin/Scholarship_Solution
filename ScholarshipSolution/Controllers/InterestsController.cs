...
namespace ScholarshipSolution.Controllers
{
    public class InterestsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "InterestID,TopicName")] Interest interest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InterestID,TopicName")] Interest interest)
        {
            if (ModelState.IsValid)
            {
